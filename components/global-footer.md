###Footer:
	...
	<footer class="wds-global-footer wds-is-en">
		...
		<div class="wds-global-footer__bottom-bar">
			...
			<div class="wds-global-footer__bottom-bar-row wds-has-border-top wds-has-no-padding"><a class="wds-global-footer__button-link" href="#">View Full Site</a></div>
		</div>
	</footer>
	...
	<footer class="wds-global-footer wds-is-international">
		...
		<div class="wds-global-footer__bottom-bar">
			...
			<div class="wds-global-footer__bottom-bar-row wds-has-border-top wds-has-no-padding"><a href="#" class="wds-global-footer__button-link">Pełna wersja strony</a></div>
		</div>
	</footer>
