...
if(i.get("isFastBoot")){var s=FastBoot.require("process").env,u=s.WIKIA_ENVIRONMENT,l=i.get("request"),c=l.get("queryParams.noexternals"),A=n(l),p=function(e,t){if("dev"===e){var n="poz"===t?"poz-dev":"sjc-dev"
return"http://dev."+n+".k8s.wikia.net"}return"http://prod."+t+".k8s.wikia.net"}(u,s.WIKIA_DATACENTER)
a={baseDomain:""+function(e){var t=e.get("headers").get("x-staging")
return t?t+".":""}(l)+n(l),cookieDomain:"."+A,servicesExternalHost:function(e){return"https://services."+e}(A),wikiaDatacenter:s.WIKIA_DATACENTER,wikiaEnv:u},Ember.isBlank(c)||(a.noExternals=Boolean(c)),o.put("runtimeConfig",a),(0,t.default)(r.APP,{gaUserSalt:s.SECRET_CHEF_GOOGLE_ANALYTICS_USER_ID_SALT||null,heliosInternalUrl:p+"/helios/info",internalCache:s.INTERNAL_CACHE_HOST||null,servicesInternalHost:p})}else a=o.retrieve("runtimeConfig");(0,t.default)(r.APP,a)}}),define("@wikia/ember-fandom/instance-initializers/request-host",["exports"],function(e){"use strict"
